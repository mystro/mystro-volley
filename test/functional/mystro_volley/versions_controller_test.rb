  ...
  class VersionsControllerTest < ActionController::TestCase
    ...
    test "should create version" do
      assert_difference('Version.count') do
        post :create, version: { files: @version.files, latest: @version.latest, name: @version.name, timestamp: @version.timestamp }
      end
    ...
    test "should update version" do
      put :update, id: @version, version: { files: @version.files, latest: @version.latest, name: @version.name, timestamp: @version.timestamp }
      assert_redirected_to version_path(assigns(:version))
    end
